...
def MyParser():
    ...
    parser.add_argument("--merging_format", type=str, default="mlp", help=["mlp", "tf"])
    parser.add_argument("--dataset_name", type=str, default=None, help=["CELEB", "LRS"])
    ...
    parser.add_argument("--vocab_name", type=str, default="vocab.txt")
